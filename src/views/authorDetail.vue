...
async function addFriend() {
    const resp = await axios.post(`UserFriend/add`, { friendId: User.value.userId }, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } })
    // console.log(resp.data.data)
    location.reload()
}
const friends = ref()
...
async function update() {
    ...
    const resp2 = await axios.post(`UserFriend/isMyFriend`, { friendId: UserId }, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } })
    isFriends.value = resp2.data.data
    console.log(isFriends.value)
...
<template>
    ...
    <div style="display: flex;width: 100%;height: 90%;position: absolute;justify-content: center;">
        ...
        <div
            ...
            <el-button @click="addFriend" v-if="!isFriends?.isMyFriend">关注他</el-button>
        </div>
        <!-- 博客 -->
        <div
